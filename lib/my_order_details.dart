        ...
        onTap: () => Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) => ViewProductPage(
                  productId: data.docs[index]['productId'], model: model),
            )),
        title: Text(
                        ...
                        child: SizedBox(
                          ...
                          child: Container(
                            ...
                            child: TextButton(
                              ...
                              onPressed: () {
                                widget.models.confirmPendingOrders(
                                    searchValue, widget.documentCollectionId);
                              },
                            ),
                          ),
                        ),
          ...
          if (isConfirm == true) {
            model
                .confirmPendingOrders(
                    widget.orderRef, widget.documentCollectionId)
                .then(
            ...
            model
                .sendTrackOrderLocation(
                    collectionGroupId: data['collectionGroupId'],
                    docId: data.id,
                    latLng: _initialCameraPosition)
                .then((value) {
              alertDialog(value);
            ...
            child: TextButton(
                ...
                onPressed: () {
                  if (widget.orderRef != null &&
                      snapshot.data.docs[index]['dispatcherLocation'] == null) {
                    return null;
                  } else {
                    setState(() {
